            ...
            <div className="sidebar">
                ...
                <nav className="mt-2">
                    ...
                    >
                        ...
                        <li className="nav-header">ТУСЛАХ САН</li>
                        <li className="nav-item">
                            <Link to="123/calendar" className="nav-link">
                                <i className="nav-icon far fa-calendar-alt" />
                                <p>Карт</p>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="123/lessons" className="nav-link">
                                <i className="nav-icon far fa-image" />
                                <p>Хичээл</p>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="123/titles" className="nav-link">
